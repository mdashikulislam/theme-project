!function (n) {
    ...
    t.prototype._selectOptionsFromConfig = function () {
        ...
        "true" == document.body.getAttribute("data-rightbar-onstart") && (localStorage.getItem("_HYPER_VISITED") || (localStorage.setItem("_HYPER_VISITED", !0), e.toggleRightSideBar())), a(document).on("click", ".end-bar-toggle", function () {
            ...
            localStorage.setItem('themeWidth',value)
            switch (a(this).val()) {
                case"fluid":
                    a.App.activateFluid();
                    break;
            ...
            localStorage.setItem('themeSidebar',a(this).val())
            switch (a(this).val()) {
                case"default":
            ...
            localStorage.setItem('themeCompact',a(this).val())
            switch (a(this).val()) {
                case"fixed":
            ...
            localStorage.removeItem('themeCompact');
            localStorage.removeItem('themeSidebar');
            localStorage.removeItem('themeWidth');
    ...
    function t() {
        ...
        this._config = {sideBarTheme:'light'},
        this.defaultSelectedStyle = null
    }

    var e = "default", o = "light", n = "dark",
